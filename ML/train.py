...
if __name__ == '__main__':
	...
	env = make_unity_env("build/ml-racing-project", 4, render=True, sim_timescale=1.0, log_dir=config.log_dir)
	...
	# model = PPO.load(config.models_dir + "image_racing_best_01.zip", env=env, device="cuda")
